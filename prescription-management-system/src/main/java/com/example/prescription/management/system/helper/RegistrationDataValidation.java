...
public class RegistrationDataValidation {
    ...
    public String patientRegistrationDataValidation(PatientRegistrationDto dto){
        ...
        if(dto.getPatientEmail()!=null && !dataValidation.isValidEmail(dto.getPatientEmail())) return "Email is not valid";
    ...
    public String doctorRegistrationDataValidation(DoctorRegistrationDto dto){
        ...
        if(dto.getDoctorEmail()!=null && !dataValidation.isValidEmail(dto.getDoctorEmail())) return "Email is not valid";
